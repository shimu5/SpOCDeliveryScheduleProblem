...
def elitist_selection(population, fitness_values, elite_size):
    ...
    elite_one = sorted_population[:elite_size]
...
def genetic_algorithm_delivery_schedule():      
    ...
    for generation in range(generations):
        ...
        for _ in range(population_size // 2):
            ...
            child1 = swap_mutation(child1, n_asteroids, n_stations, mutation_rate)
            child2 = swap_mutation(child2, n_asteroids, n_stations, mutation_rate)
...
print(solution)
ts.plot(solution, path="./images/Elit_swap_mass.png")
ts.plot_time(x=solution, path="./images/Elit_swap_Time_window.png")
ts.pretty(solution)